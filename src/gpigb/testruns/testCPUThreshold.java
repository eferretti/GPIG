...
import gpigb.analyse.RTThresholdAnalyser;
...
public class testCPUThreshold {
	public static void main(String[] args) throws InterruptedException
	{
		...
		Integer analID = aMgr.getModuleIDByName("gpigb.analyse.ThresholdAnalyser");	
		...
		Integer repID = rMgr.getModuleIDByName("gpigb.report.OutOfRangeReporter");
