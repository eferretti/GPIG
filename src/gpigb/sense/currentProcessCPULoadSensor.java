...
public class currentProcessCPULoadSensor implements Sensor<Double>, Configurable
{
	...
	public Double poll()
	{
		for (Method method: operatingSystemMXBean.getClass ().getMethods ()) 
		{
		    ...
		    if (methodName.startsWith ("getSystemCpuLoad")
		        ...
		        {     
		               ...
		               System.out.println("Current HUMS CPU usage: " + currentUsage);
		        }
		        catch (Throwable ex)
		        {
		            // Catch a flu
	...
	public static void main(String[] args) {
		currentProcessCPULoadSensor sens = new currentProcessCPULoadSensor();
		while(true) {
