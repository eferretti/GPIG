...
public class DataSet<DataType>
{
	...
	private List<DataRecord<DataType>> data;
	 ...
	 */
	public DataSet(Date from, Date to, int sensor)
	{
	 ...
	 */
	public void addRecord(DataRecord<DataType> data)
	{
	 ...
	 */
	public boolean equals(DataSet<DataType> rs)
	{
	 ...
	 * @return the record
	 */
	public DataRecord<DataType> getDataAtPosition(int pos)
	{
