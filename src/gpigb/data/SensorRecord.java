...
public class SensorRecord<ReadingType>
{
	 ...
	 * @param sensorID The ID of the sensor which made this reading
	 * @param data The reading made by the sensor
	 * @param metaArgs An array (or variable length list) of key, value pairs to be stored as meta data
	 */
