...
public interface ComponentManager<Interface>
{
	...
	/**
	 * Add a directory to be scanned for available modules.
	 * Sub directories should not be scanned in most cases.
	 * @param path The directory path to be added
	 * @return true iff the path is a valid directory and will be scanned on future refreshes
	 */
	public boolean addModuleDirectory(String path);
	
	/**
	 * Refreshes the available modules, canning the directories provided and updating
	 ...
	 * @param moduleID The type of object to create
	 ...
	 * @param instanceID the ID of the object to be retrieved
	 * @return A {@link gpigb.classloading.StrongReference} to the requested object, or null if an error occurs
	 */
