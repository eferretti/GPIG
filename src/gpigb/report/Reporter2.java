...
public class Reporter2 implements Reporter {
	...
	public void GenerateReport(List<RecordSet<?>> data) {
		...
		String errorMessage = "SensorID: " + errorSigniture.getSensorID() + " TimeFrom: " + errorSigniture.getFromTime() + " TimeTo: " +  errorSigniture.getToTime() + "\n";
		System.out.print( errorMessage);
		Long timeFrame = errorSigniture.getToTime().getTime() - errorSigniture.getFromTime().getTime();
		Integer valueDifference = errorSigniture.getReadingAtPosition(0).getData() - errorSigniture.getReadingAtPosition( errorSigniture.getRecordCount()).getData();
